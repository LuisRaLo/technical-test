...
type Response400WithResult struct {
	...
	Details []string `json:"resultado" example:"Error en la petición" format:"string"`
}
type Response401WithResult struct {
	Folio   string   `json:"folio,omitempty" example:"" format:"string"`
	Message string   `json:"mensaje" example:"Operación realizada sin éxito" format:"string"`
	Details []string `json:"resultado" example:"No se encontró el recurso solicitado" format:"string"`
}
...
type Response500WithResult struct {
	...
	Details []string `json:"resultado" example:"Error interno del servidor" format:"string"`
}
