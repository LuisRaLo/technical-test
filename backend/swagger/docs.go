            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/repositories.GetAllBondsResponse200"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.SellResponse": {
            ...
            "properties": {
                ...
                "resultado": {
                    "$ref": "#/definitions/domain.SellResponseResult"
                }
            }
        },
        "domain.SellResponseResult": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string",
        ...
        "repositories.GetAllBondsResponse": {
            "type": "object",
            "properties": {
                "bonds": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/repositories.BondModel"
                    }
                }
            }
        },
        "repositories.GetAllBondsResponse200": {
            "type": "object",
            "properties": {
                "folio": {
                    "type": "string",
                ...
                "result": {
                    "$ref": "#/definitions/repositories.GetAllBondsResponse"
                }
            }
        },
